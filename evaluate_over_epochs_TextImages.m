...
for epoch = 1:1000
    ...
    model_filename = ['./models/LapSRN_x' num2str(model_scale) '_depth10_L1_train_EN100_FR100_VN100_pw128_lr1e-05_step50_drop0.5_min1e-06_bs64/net-epoch-' num2str(epoch) '.mat'];
%    
    fprintf('Load %s\n', model_filename);
...
% 
filename = fullfile(output_dir,['PSNR_SSIM_x' num2str(model_scale) '.mat']);
