...
% dataset     = 'TextImageDataset/Test';
dataset     = 'Test30';
test_scale  = 2; %model_scale;  % testing scale can be different from model scale
...
model_filename = './models/LapSRN_x4_depth10_L1_GDL_1.000000e-01_train_EN100_FR100_VN100_pw128_lr1e-05_step50_drop0.5_min1e-06_bs64/net-epoch-995.mat';
% model_filename = './models/LapSRN_x4_depth10_L1_train_EN100_FR100_VN100_pw128_lr1e-05_step20_drop0.5_min1e-06_bs64/net-epoch-995.mat';
