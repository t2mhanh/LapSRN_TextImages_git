...
for epoch = 1:1000
    ...
    model_filename = ['./models/LapSRN_x' num2str(model_scale) '_depth10_L1_GDL_1.000000e-01_train_EN100_FR100_VN100_pw128_lr1e-05_step50_drop0.5_min1e-06_bs64/net-epoch-' num2str(epoch) '.mat'];
%     model_filename = ['./models/LapSRN_x4_depth10_L1_train_EN_FR_VN_pw128_lr1e-05_step50_drop0.5_min1e-06_bs64/net-epoch-' num2str(epoch) '.mat'];
...
%         imwrite(img_HR, output_filename);
    ...
    PSNR_epochs(end+1) = mean(PSNR);
    SSIM_epochs(end+1) = mean(SSIM);
    IFC_epochs(end+1)  = mean(IFC);
    
     
end

% 
filename = fullfile(output_dir,['PSNR_SSIM_GDL_x' num2str(model_scale) '.mat']);
save(filename,'PSNR_epochs','SSIM_epochs','IFC_epochs')
